            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                        <a  href="/index.php/Admin/Our/add" title="新增路线"><i class="glyphicon glyphicon-plus"></i></a>
                        &emsp;
                    </div>
                    </div>
                    ...
                    <div class="ibox-content">
                        <table class="table">
                            ...
                            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td title="<?php echo ($vo["address"]); ?>"><?php echo (mb_substr($vo["address"],0,30)); ?></td>
                                    <td title="<?php echo ($vo["line"]); ?>"><?php echo (mb_substr($vo["line"],0,30)); ?></td>
                                    <td><?php echo ($vo["email"]); ?></td>
                                    <td><?php echo ($vo["telephone_number"]); ?></td>
                                    <td>
                                        <a  href="/index.php/Admin/Our/edit/id/<?php echo ($vo["id"]); ?>" title="编辑"><i class="glyphicon glyphicon-pencil"></i></a>
                                        &emsp;
                                        <a href="javascript:;" title="删除" onclick="ask('<?php echo ($vo["id"]); ?>')"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
    ...
    <script>
        function ask(id, which) {
            layer.confirm('确定删除吗？', {
                ...
                location.href = '/index.php/Admin/Our/' +which+ 'Del/id/'+id;
            });
        }
