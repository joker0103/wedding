                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/Public/Admin/img/profile.jpg">
                                    </a>
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/Public/Admin/img/a2.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/Public/Admin/img/a3.jpg">
                                    </a>
                                    <div class="media-body ">
                                ...
                                <div class="feed-element">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="/Public/Admin/img/a5.jpg">
                                    </a>
                                    <div class="media-body ">
...
<script src="/Public/Admin/js/plugins/fancybox/jquery.fancybox.js"></script>
    ...
    <script>
        var freshMassage = <?php echo ($new); ?>;
        if (freshMassage == 0) {
            var titleInfo = '当前暂无消息';
            var textInfo = '';
        } else {
            var titleInfo = "您有" + freshMassage + "条未读信息";
            var textInfo = '请前往<a href="/index.php/Admin/Mail/index" class="text-warning">收件箱</a>查看今日任务';
        }
        $(document).ready(function(){WinMove();setTimeout(function(){$.gritter.add({title:titleInfo,text:textInfo,time:10000})},2000);$(".chart").easyPieChart({barColor:"#f8ac59",scaleLength:5,lineWidth:4,size:80});$(".chart2").easyPieChart({barColor:"#1c84c6",scaleLength:5,lineWidth:4,size:80});var data1=[[0,4],[1,8],[2,5],[3,10],[4,4],[5,16],[6,5],[7,11],[8,6],[9,11],[10,30],[11,10],[12,13],[13,4],[14,3],[15,3],[16,6]];var data2=[[0,1],[1,0],[2,2],[3,0],[4,1],[5,3],[6,1],[7,5],[8,2],[9,3],[10,2],[11,1],[12,0],[13,2],[14,8],[15,0],[16,0]];$("#flot-dashboard-chart").length&&$.plot($("#flot-dashboard-chart"),[data1,data2],{series:{lines:{show:false,fill:true},splines:{show:true,tension:0.4,lineWidth:1,fill:0.4},points:{radius:0,show:true},shadowSize:2},grid:{hoverable:true,clickable:true,tickColor:"#d5d5d5",borderWidth:1,color:"#d5d5d5"},colors:["#1ab394","#464f88"],xaxis:{},yaxis:{ticks:4},tooltip:false})});
    </script>
</body>
</html>