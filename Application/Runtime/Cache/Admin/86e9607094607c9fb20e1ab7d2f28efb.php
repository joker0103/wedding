                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo U('edited');?>">
                            ...
                            <input type="hidden" value="<?php echo ($article["author"]); ?>" name="author">
                            <!--标题-->
                            <div class="form-group">
                                <label class="col-sm-2 control-label">标题</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" maxlength="32" value="<?php echo ($article["title"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="synopsis" maxlength="64" value="<?php echo ($article["synopsis"]); ?>">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control m-b" name="wedding">
                                        <?php if(is_array($wed)): $i = 0; $__LIST__ = $wed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>" <?php if($atrticle['wedding'] == $vol['id']): ?>selected<?php endif; ?> >
                                            <?php echo ($vol["bride"]); ?>&<?php echo ($vol["bridegroom"]); ?>
