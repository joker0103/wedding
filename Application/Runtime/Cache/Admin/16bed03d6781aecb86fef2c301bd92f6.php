                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo U('added');?>">
                            <?php switch($type): case "1": ?><input type="hidden" name="type" value="1">
                                    <!--日期-->
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">时间：</label>
                                        <div class="col-sm-10">
                                            <input name="time" class="form-control layer-date" placeholder="年-月-日 时:分:秒" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                ...
                                <?php case "2": ?><input type="hidden" name="type" value="2">
                                    <!--简介-->
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="personal_synopsis"></textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <!--职员照片-->
...
<script src="/Public/Admin/js/plugins/fancybox/jquery.fancybox.js"></script>
    ...
    <?php if($type == 1 ): ?><script src="/Public/Admin/js/plugins/layer/laydate/laydate.js"></script>
    <script>
