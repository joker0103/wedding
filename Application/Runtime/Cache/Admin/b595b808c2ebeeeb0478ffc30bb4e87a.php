...
<body class="signin">
    <div class="signinpanel">
        <div class="row">
            ...
            <div class="col-sm-5">
                <form method="post" action="<?php echo U('check');?>">
                    ...
                    <span class="help-block m-b-none"><img src="<?php echo U('captcha');?>" onclick="this.src='/index.php/Admin/Index/captcha/cap/'+Math.random();"></span>
                    <input type="text" name="captcha" class="form-control captcha" placeholder="验证码"/>
                    <span class="help-block m-b-none"><?php if($Think.session.massage): ?><font color="red"><?php echo (session('massage')); ?></font><?php endif; ?></span>
