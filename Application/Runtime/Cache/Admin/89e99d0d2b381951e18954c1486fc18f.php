                ...
                <div class="contact-box">
                    <a href="/index.php/Admin/Blog/article/id/<?php echo ($vol["id"]); ?>" target="_blank">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div><?php echo (mb_substr($vol["synopsis"],0,20)); ?> ...</div>
                        </div>
                        <div class="clearfix"></div>
                    </a>
                    <a  href="/index.php/Admin/Blog/edit/id/<?php echo ($vol["id"]); ?>" title="编辑"><i class="glyphicon glyphicon-pencil"></i></a>
                    &emsp;
    ...
    <script>
        function ask(id) {
            layer.confirm('确定删除吗？', {
                ...
                location.href = '/index.php/Admin/Blog/del/id/'+id;
            });
        }
