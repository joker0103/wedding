<?php if (!defined('THINK_PATH')) exit();?><html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		<title>freemoban</title>
		
		<meta name="description" content="" />
		<meta name="keywords" content="" />
		
		<script type="text/javascript" src="38041-swfobject.js"></script>
        <script type="text/javascript" src="38041-motoResize.js"></script>
		<script type="text/javascript">
			...
			swfobject.embedSWF("38041.swf", "flashcontent", "100%", "100%", "10.0.0", "38041-expressinstall.swf", {}, params, {});

			if (swfobject.hasFlashPlayerVersion("6.0.0")) {
				swfobject.addDomLoadEvent(createFullBrowserFlash);
			}
		</script>
       <link href="38041-style.css" rel="stylesheet" type="text/css"/>
