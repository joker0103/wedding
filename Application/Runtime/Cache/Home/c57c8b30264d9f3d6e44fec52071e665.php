	...
	<body>
		...
		<!--start-image-slider---->
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      <li>
					      	<img src="/Public/Home/images/slider1.jpg" alt="">
					      ...
					      <li><img src="/Public/Home/images/slider2.jpg" alt="">
					      	<div class="slider-info">
					      		<p>Traveling the best Traveling website</p>
					      		<span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </span>
					      		<a href="#">ReadMore</a>
					      ...
					      <li><img src="/Public/Home/images/slider3.jpg" alt="">
					      	<div class="slider-info">
					      		<p>Traveling the best Traveling website</p>
					      		<span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </span>
					      		<a href="#">ReadMore</a>
		...
		<div class="content">
			...
			<div class="content-grids">
				<div class="grid">
					<a href="#"><img src="/Public/Home/images/grids-img1.jpg" title="image-name" /></a>
					<h3>DESTINATIONS</h3>
				...
				<div class="grid">
					<a href="#"><img src="/Public/Home/images/grids-img2.jpg" title="image-name" /></a>
					<h3>NEWS & EVENTS</h3>
					<p>Lorem ipsum dolor sit amet consectetur adiing elit. In volutpat luctus eros ac placerat. Quisque erat metus facilisis non feu,aliquam hendrerit quam. Donec ut lectus vel dolor adipiscing tincnt.</p>
					<a class="button" href="#">More</a>
				</div>
				<div class="grid last-grid">
					<a href="#"><img src="/Public/Home/images/grids-img3.jpg" title="image-name" /></a>
					<h3>SUPPORT</h3>
					<p>Lorem ipsum dolor sit amet consectetur adiing elit. In volutpat luctus eros ac placerat. Quisque erat metus facilisis non feu,aliquam hendrerit quam. Donec ut lectus vel dolor adipiscing tincnt.</p>
					<a class="button" href="#">More</a>
				</div>
