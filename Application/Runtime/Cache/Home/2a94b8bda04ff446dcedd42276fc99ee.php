...
<div class="content">
	<div class="container">
		<div class="col-md-6 content-col">
			<img src="/Public/Home/images/pic1.jpg" alt="">
		</div>
		<div class="col-md-6 content-col col_2">
			<h2>Welcome</h2>
			<p>There are many variations of passages of Lorem Ipsum available.</p>
			<p>Nunc mattis elementum massa, elementum volutpat dolor vestibulum sit amet. Mauris a eros id est dictum pretium sed vitae nisl. Donec porta eleifend nibh, a faucibus mi euismod vel.</p>
		</div>
...
<div class="footer">
    <div class="container">
        <p>Copyright &copy; 2016 WEDDING文化股份有限公司 <a href="http://www.weeding.com/">www.weeding.com</a> | 京ICP备12012010号-1  公安备案号：京公网安备1010101407号</p>
    </div>
</div>
</body>
</html>